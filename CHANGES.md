...
* Color management improvements:
  ...
  - *color mgmt*: Map the CICP Rec.709 primaries + sRGB-transfer tuple to display-referred sRGB (`srgb_rec709_display`) rather than the scene-referred entry, so CICP-tagged reads resolve to the intended display encoding. [#XXXX](https://github.com/AcademySoftwareFoundation/OpenImageIO/pull/XXXX) (3.2.0.3)
