...
#${OIIOTOOL} ../../../../oiio-images/tahoe-gps.jpg --colorconvert srgb_rec709_scene scene_linear --resize 320x240 --colorconvert scene_linear srgb_rec709_scene -o tahoe-small.jpg
#${OIIOTOOL} ../../../../oiio-images/grid.tif --resize 256x256 --colorconvert scene_linear srgb_rec709_scene -o grid-small.jpg

${OIIOTOOL} tahoe-small.jpg --tocolorspace scene_linear --addc 0.2 --tocolorspace srgb_rec709_scene -o addc.jpg
${OIIOTOOL} tahoe-small.jpg --tocolorspace scene_linear --mulc 0.5 --tocolorspace srgb_rec709_scene -o mulc.jpg
${OIIOTOOL} tahoe-small.jpg --tocolorspace scene_linear --chsum:weight=.2126,.7152,.0722 --ch 0,0,0 --tocolorspace srgb_rec709_scene -o luma.jpg
...
${OIIOTOOL} --pattern fill:bottom=1,0.7,0.7:top=1,0,0  320x240 3 --fill:color=1,0,0 50x100+50+75 --tocolorspace srgb_rec709_scene -o fill.jpg
#${OIIOTOOL} --create 320x240 3 -fill:bottom=1,0.7,0.7:top=1,0,0 320x240 --tocolorspace srgb_rec709_scene -o fill2.jpg
${OIIOTOOL} --pattern checker:color1=0.1,0.1,0.1:color2=0.4,0.4,0.4:width=32:height=32 320x240 3 --tocolorspace srgb_rec709_scene -o checker.jpg
${OIIOTOOL} --pattern fill:top=0.1,0.1,0.1:bottom=0,0,0.75 320x240 3 --tocolorspace srgb_rec709_scene -o gradient.jpg
${OIIOTOOL} --pattern fill:left=0.1,0.1,0.1:right=0,0.75,0 320x240 3 --tocolorspace srgb_rec709_scene -o gradienth.jpg
${OIIOTOOL} --pattern fill:topleft=.1,.1,.1:topright=1,0,0:bottomleft=0,1,0:bottomright=0,0,1 320x240 3 --tocolorspace srgb_rec709_scene -o gradient4.jpg
${OIIOTOOL} --pattern checker:width=16:height=16 256x256 3 --tocolorspace srgb_rec709_scene -o checker.jpg
${OIIOTOOL} --pattern noise:type=white:min=0:max=1:mono=1 256x256 3 --tocolorspace srgb_rec709_scene -o unifnoise1.jpg
${OIIOTOOL} --pattern noise:type=white:min=0:max=1 256x256 3 --tocolorspace srgb_rec709_scene -o unifnoise3.jpg
${OIIOTOOL} --pattern noise:type=blue:min=0:max=1:mono=1 256x256 3 --tocolorspace srgb_rec709_scene -o bluenoise.jpg
${OIIOTOOL} --pattern noise:type=gaussian:mean=0.5:stddev=0.2 256x256 3 --tocolorspace srgb_rec709_scene -o gaussnoise.jpg
...
${OIIOTOOL} --create 320x240 3 --text:x=25:y=50 "Hello, world" \
            ...
            --tocolorspace srgb_rec709_scene -o text.jpg
${OIIOTOOL} --create 320x240 3 --text:x=160:y=120:xalign=center:yalign=center:size=40 "Centered" \
            --tocolorspace srgb_rec709_scene -o textcentered.jpg
${OIIOTOOL} tahoe-small.jpg \
            ...
            --tocolorspace srgb_rec709_scene -o textshadowed.jpg
${OIIOTOOL} tahoe-small.jpg --crop 100x120+35+40 \
            -ch R,G,B,A=1.0 -create 320x240 4 -fill:color=0.75,0.75,0.75,1 320x240 \
            -fill:color=1,1,1,1 318x238+1+1 -over -tocolorspace srgb_rec709_scene -o crop.jpg
${OIIOTOOL} tahoe-small.jpg --cut 100x120+35+40 -tocolorspace srgb_rec709_scene -o cut.jpg
${OIIOTOOL} -create 320x240 4 -fill:color=.1,.5,.1 120x80+50+70 -rotate 30 -o pretrim.jpg \
            ...
            -fill:color=1,1,1,1 318x238+1+1 -over -tocolorspace srgb_rec709_scene -o trim.jpg
...
${OIIOTOOL} --pattern checker:color1=.1,.2,.1:color2=.2,.2,.2 320x240 3 \
            ...
            --colorconvert scene_linear srgb_rec709_scene -d uint8 -o box.png
