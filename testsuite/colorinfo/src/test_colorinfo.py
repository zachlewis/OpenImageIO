...
# Python binding of the cheap color-space property surface:
...
# input is [] with one indexed error. Nothing here derives: fields that
# would require behavioral derivation report computed(field) False.
...
print ("binding: reserved options accepted and ignored =")
reserved = cc.get_color_space_info("my_srgb", profile="show",
                                   policies="oiio:colorpolicy:example=1")
print ("  name =", reserved.name)
print ("  encoding =", reserved.encoding)
