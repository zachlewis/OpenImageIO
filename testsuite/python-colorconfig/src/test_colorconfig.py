...
try:
    ...
    print ("Index of 'lin_rec709_scene' =", config.getColorSpaceIndex('lin_rec709_scene'))
    ...
    print ("equivalent('scene_linear', 'lin_rec709_scene'):", config.equivalent("scene_linear", "lin_rec709_scene"))
    ...
    print ("get_color_interop_id('lin_rec709_scene') = ", config.get_color_interop_id("lin_rec709_scene"))
