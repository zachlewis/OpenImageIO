...
try:
    ...
    s = oiio.ImageSpec()
    s.set_cicp("1,2,3,4")
    print ("  after set_cicp('1,2,3,4'):", s.getattribute("oiio:CICP", "uint8[4]"))
    s.set_cicp("")
    print ("  after set_cicp(''):", s.getattribute("oiio:CICP"))
    s.set_cicp(1, 2)
    print ("  after set_cicp(1,2):", s.getattribute("oiio:CICP", "uint8[4]"))
    s.set_cicp(1, 2, 3)
    print ("  after set_cicp(1,2,3):", s.getattribute("oiio:CICP", "uint8[4]"))
    s.set_cicp(1, 2, 3, 4)
    print ("  after set_cicp(1,2,3,4):", s.getattribute("oiio:CICP", "uint8[4]"))
    s.set_cicp(",,,0")
    print ("  after set_cicp(',,,0'):", s.getattribute("oiio:CICP", "uint8[4]"))
    s.set_cicp("1,13,1")
    print ("  after set_cicp('1,13,1'):", s.getattribute("oiio:CICP", "uint8[4]"))
    s.set_cicp(",4")
    print ("  after set_cicp(',4'):", s.getattribute("oiio:CICP", "uint8[4]"))
